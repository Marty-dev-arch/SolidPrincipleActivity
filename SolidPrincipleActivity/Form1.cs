...
namespace SolidPrincipleActivity
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            cmbDiscountType.Items.AddRange(new object[]
            {
                "None",
                "Student",
                "Senior",
            ...
            cmbDiscountType.IntegralHeight = false;
            cmbDiscountType.DropDownHeight = 150;
            ...
            _discountStrategies = new Dictionary<string, IDiscountStrategy>
            {
                ...
                { "FreeShippingDiscount", new FreeShippingDiscount() }
            };
        }
